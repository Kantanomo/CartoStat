...
<?php if($Variant->Settings["Team"] == 1){
    ...
    foreach($Players as $Player){
        ...
        $teamScores[$Player->Team] += $Player->FlagScores;
    }
...
<div class="player-stats" data-title="Player Stats">
    <div class="score-row header">
        ...
        <div class="column header flagsaves">
            <p>Flag Saves</p>
        </div>
        <div class="column header flagsteals">
            <p>Flag Steals</p>
        </div>
        <div class="column header score">
            <p>Score</p>
    ...
    ?>
        <div class = "score-row">
            ...
            <div class="column flagsaves <?php echo $Color ?>">
                <p><? echo $Player->FlagSaves ?></p>
            </div>
            <div class="column flagsteals <?php echo $Color ?>">
                <p><? echo $Player->FlagSteals ?></p>
            </div>
            <div class="column score <?php echo $Color ?>">
                <p><? echo $Player->FlagScores ?></p>
            </div>
        </div>
    <?php endforeach; ?>
</div>