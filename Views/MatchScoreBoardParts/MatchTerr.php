...
<div class="player-stats" data-title="Player Stats">
    <div class="score-row header">
        ...
        <div class="column header terrtaken">
            <p>Terr. Taken</p>
        </div>
        <div class="column header terrlost">
            <p>Terr. Lost</p>
        </div>
        <div class="column header score">
            <p>Score</p>
    ...
    ?>
        <div class = "score-row">
            ...
            <div class="column terrtaken <?php echo $Color ?>">
                <p><? echo $Player->TerrTaken; ?></p>
            </div>
            <div class="column terrlost <?php echo $Color ?>">
                <p><? echo $Player->TerrLost; ?></p>
            </div>
            <div class="column score <?php echo $Color ?>">
